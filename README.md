																											        ...
																											        - <p>File exists</p>
																													      ...
																													      <li class="list-group-item alert alert-success">
																																		      ...
																																		      7.5 out of 15 points
																																				        ...
																																				        - <p>Fix the order of the <code>if/elif</code> statements</p>
																																						        ...
																																						        <li class="list-group-item alert alert-success">
																																											        ...
																																											        2.5 out of 5 points
																																													         ...
																																													         - <p>Correct output for <code>./0-fizzbuzz.py 89</code></p>

																																														   	      	     </li>
																																																      <h4 class="gap">Print square</h4>
																																																      	  <h5>New correction at 50.0%</h5>
																																																	  	  	     <ul class="list-group sm-gap">
																																																			     	 		    <li class="list-group-item alert alert-success">
																																																						    			       	      <strong>
																																																																						     ...
																																																																						     - <p>Change base 16 to base 10</p>
																																																																								         ...
																																																																								         <li class="list-group-item alert alert-success">
																																																																													         ...
																																																																													         0.5 out of 1 points
																																																																															          ...
																																																																															          - <p>Correct output: <code>./1-print_square.js 0</code></p>
																																																																																		          ...
																																																																																		          <li class="list-group-item alert alert-success">
																																																																																							          ...
																																																																																							          0.5 out of 1 points
																																																																																									           ...
																																																																																									           - <p>Correct output: <code>./1-print_square.js 4</code></p>
																																																																																													   ...
																																																																																													   <li class="list-group-item alert alert-success">
																																																																																																	           ...
																																																																																																	           1.5 out of 3 points
																																																																																																				    ...
																																																																																																				    - <p>Correct output: <code>./1-print_square.js 20</code></p>

																																																																																																				      		 	 </li>
																																																																																																							  <h4 class="gap">Sort</h4>
																																																																																																							      <h5>New correction at 50.0%</h5>
																																																																																																							      	      		 <ul class="list-group sm-gap">
																																																																																																										     		        <li class="list-group-item alert alert-success">
																																																																																																													    			   	  <strong>
																																																																																																																			         ...
																																																																																																																			         - <p>File exists</p>
																																																																																																																					       ...
																																																																																																																					       <li class="list-group-item alert alert-success">
																																																																																																																										       ...
																																																																																																																										       7.5 out of 15 points
																																																																																																																												         ...
																																																																																																																												         - <p><code>-1</code> removed in the <code>insert</code> method call</p>
																																																																																																																																         ...
																																																																																																																																         <li class="list-group-item alert alert-success">
																																																																																																																																					         ...
																																																																																																																																					         2.5 out of 5 points
																																																																																																																																							          ...
																																																																																																																																							          - <p>Correct output: <code>ruby 2-sort.rb 12 9 41 -2 H 0 -3 do 21 -1 32</code></p>

																																																																																																																																								    	       	       </li>
																																																																																																																																										        <h4 class="gap">User password</h4>
																																																																																																																																											    <h5>New correction at 50.0%</h5>
																																																																																																																																											    	    	       <ul class="list-group sm-gap">
																																																																																																																																													       	   		      <li class="list-group-item alert alert-success">
																																																																																																																																																      	  			        <strong>
																																																																																																																																																																																					          ...
																																																																																																																																																																																					          - <p>Correct output</p>
																																																																																																																																																																																						    	          ...
																																																																																																																																																																																						    	          <p class="sm-gap"><strong>files: </strong>
																																																																																																																																																																																								     				       <a target="_blank" href="https://holbertonintranet.s3.amazonaws.com/files/correction_system/372/2438/main_0.py">main_0.py</a>, 
																																																																																																																																																																																																													    ...
																																																																																																																																																																																																													    <h4 class="gap">Double linked list</h4>
																																																																																																																																																																																																													    	<h5>New correction at 50.0%</h5>
																																																																																																																																																																																																																   <ul class="list-group sm-gap">
																																																																																																																																																																																																																       			  <li class="list-group-item alert alert-success">
																																																																																																																																																																																																																			      			     	    <strong>
